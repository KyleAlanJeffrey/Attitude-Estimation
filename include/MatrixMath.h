...
/* MatrixInverse Copies from one matrix to next.
 * @param: mat1, a pointer to a 3x3 matrix copying from
 * @param: mat2, a pointer to a 3x3 matrix copied to
 * @return: none
 * mat is not modified by this function.  mat2 is modified by this function.
 */
